...
var l = new Lagrange(0, 9.81, 20000, 9.7487);
var index = l.addPoint(40000, 9.6879);
var index = l.addPoint(60000, 9.6879);
var index = l.addPoint(80000, 9.5682);
console.log(l.valueOf(42000));